            ...
            <div className="container">
                ...
                <div className="box">
                    ...
                    <div>
                        ...
                        <input type="number" onChange={this.changeBreakpoint1.bind(this)}></input>
                    </div>
                </div>
                ...
                <div className="box">
                    <span>Color 2</span>
                    <div>
                        <input type="color" onChange={this.onChange2.bind(this)}></input>
                    </div>

                    <div>
                        <label>Breakpoint</label>
                        <input type="number" onChange={this.changeBreakpoint2.bind(this)}></input>
                    </div>
                </div> 
                ...
                <div className="box">
                    <span>Color 3</span>
                    <div>
                        <input type="color" onChange={this.onChange3.bind(this)}></input>
                    </div>

                    <div>
                        <label>Breakpoint</label>
                        <input type="number" onChange={this.changeBreakpoint3.bind(this)}></input>
                    </div>
                </div>

                <div className="box">
                    <label>Rotation</label>
                    <input type='range' onChange={this.changeRotation.bind(this)}></input>
                </div>
